@extends('admin.adminpos_dashboard')
@section('admin')

@php
$date = date('d-F-Y');
$today_paid = App\Models\POrder::where('order_date',$date)->sum('pay');

$total_paid = App\Models\POrder::sum('pay');
$total_due = App\Models\POrder::sum('due');

$completeorder = App\Models\POrder::where('order_status','complete')->get();

$pendingorder = App\Models\POrder::where('order_status','pending')->get();
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <h3 class="text-dark mt-1"> <span
                                            data-plugin="counterup">{{ count($completeorder)  }}</span></h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="text-end">
                                    <h3 class="text-dark mt-1"> <span
                                            data-plugin="counterup">{{ count($pendingorder)  }}</span></h3>
