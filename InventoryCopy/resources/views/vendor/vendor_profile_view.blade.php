                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('vendor.profile.store') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="vendor_join" class="form-select form-select-sm mb-3"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea name="vendor_short_info" class="form-control" id="inputAddress"
                                            placeholder="Vendor Info..." rows="3">
