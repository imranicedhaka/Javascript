    ...
    <article class="card">
        ...
        <div class="card-body">
            ...
            <div class="track">
                ...
                <div class="step"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text"> Order
                        Confirmed</span> </div>

                <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">Order
                        Processing </span> </div>

                <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Delivered
                    </span> </div>
            ...
            <hr>
            <a href="{{ route('user.track.order') }}" class="btn btn-warning" data-abc="true"> <i
