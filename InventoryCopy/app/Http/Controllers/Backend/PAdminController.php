...
class PAdminController extends Controller
{
   ...
   /////////////////// Admin User All Method /////////////
    ...
    public function AllAdmin(){
        ...
        return view('backend.padmin.all_admin',compact('alladminuser'));
    }// End Method 

    public function AddAdmin(){

        $roles = Role::all();
        return view('backend.padmin.add_admin',compact('roles'));
    }// End Method 
    ...
    public function StoreAdmin(Request $request){
        ...
        return redirect()->route('all.padmin')->with($notification);  
    ...
    public function EditAdmin($id){
        ...
        return view('backend.padmin.edit_admin',compact('roles','adminuser'));
    ...
    public function DatabaseBackup(){
        ...
        return view('backend.padmin.db_backup')->with('files',File::allFiles(storage_path('/app/Easy')));
