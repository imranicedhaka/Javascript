...
class PCustomerController extends Controller
{
    public function AllCustomer(){

        $customer = PCustomer::latest()->get();
 ...
 public function EditCustomer($id){
        ...
        $customer = PCustomer::findOrFail($id);
     ...
     public function UpdateCustomer(Request $request){
        ...
        PCustomer::findOrFail($customer_id)->update([
 ...
 public function DeleteCustomer($id){
        ...
        $customer_img = PCustomer::findOrFail($id);
        $img = $customer_img->image;
        unlink($img);

        PCustomer::findOrFail($id)->delete();
